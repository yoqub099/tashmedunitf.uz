...
const SCHEME_PREVIEW: Record<A11yScheme, { bg: string; fg: string; accent: string; label: string }> = {
  default: { bg: "#ffffff", fg: "#111827", accent: "#1d4ed8", label: "Aa" },
        ...
        <>
          ...
          >
            ...
            <div data-a11y-ui="true" className="a11y-panel-content">
              {/* Font size */}
              <Section number={1} title={A11Y_LABELS.fontSize}>
                <div data-a11y-ui="true" className="a11y-segmented">
                  {(["small", "medium", "large"] as A11yFontSize[]).map((v) => {
                    ...
                    const labels: Record<A11yFontSize, string> = {
                      small: A11Y_LABELS.fontSizeSmall,
                      medium: A11Y_LABELS.fontSizeMedium,
                      large: A11Y_LABELS.fontSizeLarge,
                    };
                    return (
                      <button
                        key={v}
              ...
              {/* Color schemes */}
              <Section number={2} title={A11Y_LABELS.scheme}>
                <div data-a11y-ui="true" className="a11y-scheme-grid">
                  {(Object.keys(SCHEME_PREVIEW) as A11yScheme[]).map((v) => {
                    ...
                    const labels: Record<A11yScheme, string> = {
                      default: A11Y_LABELS.schemeDefault,
                      bw: A11Y_LABELS.schemeBw,
                      wb: A11Y_LABELS.schemeWb,
                      yb: A11Y_LABELS.schemeYb,
                      by: A11Y_LABELS.schemeBy,
                      sepia: A11Y_LABELS.schemeSepia,
                    };
                    return (
                      <button
                        key={v}
              ...
              {/* Letter spacing */}
              <Section number={3} title={A11Y_LABELS.letterSpacing}>
                <div data-a11y-ui="true" className="a11y-segmented">
                  {(["normal", "wide", "extra-wide"] as A11yLetterSpacing[]).map((v) => {
                    ...
                    const labels: Record<A11yLetterSpacing, string> = {
                      normal: A11Y_LABELS.letterSpacingNormal,
                      wide: A11Y_LABELS.letterSpacingWide,
                      "extra-wide": A11Y_LABELS.letterSpacingExtra,
                    };
                    return (
                      <button
                        key={v}
              ...
              {/* Line height */}
              <Section number={4} title={A11Y_LABELS.lineHeight}>
                <div data-a11y-ui="true" className="a11y-segmented" style={{ gridTemplateColumns: "1fr 1fr" }}>
                  {(["normal", "comfortable"] as A11yLineHeight[]).map((v) => {
                    ...
                    const labels: Record<A11yLineHeight, string> = {
                      normal: A11Y_LABELS.lineHeightNormal,
                      comfortable: A11Y_LABELS.lineHeightComfortable,
                    };
                    return (
                      <button
                        key={v}
              ...
              {/* Font family */}
              <Section number={5} title={A11Y_LABELS.fontFamily}>
                <div data-a11y-ui="true" className="a11y-segmented" style={{ gridTemplateColumns: "1fr 1fr" }}>
                  {(["sans", "serif"] as A11yFontFamily[]).map((v) => {
                    ...
                    const labels: Record<A11yFontFamily, string> = {
                      sans: A11Y_LABELS.fontFamilySans,
                      serif: A11Y_LABELS.fontFamilySerif,
                    };
                    return (
                      <button
                        key={v}
              ...
              >
                ...
                <span data-a11y-ui="true">{A11Y_LABELS.reset}</span>
              </button>
            </div>
          </motion.div>
        </>
