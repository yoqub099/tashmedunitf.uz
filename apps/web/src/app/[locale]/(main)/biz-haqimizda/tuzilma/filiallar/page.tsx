    ...
    <div className="pt-20 lg:pt-24">
      <Container as="section" className="py-6">
        ...
        <section className="mt-4">
          <div className="rounded-2xl bg-gray-100 p-4 text-gray-900 md:p-6 lg:rounded-3xl">
            <div className="flex flex-col items-start justify-between gap-3 md:flex-row">
              <h3 className="font-serif text-2xl font-semibold lg:text-[32px]">
                {s("filial.location", lang)}
              </h3>
            </div>

            <div className="mt-6">
              <div>
                <h4 className="font-serif text-2xl font-semibold">{s("filial.city_termez", lang)}</h4>
                {loading ? (
                ...
                <div className="mt-4 flex min-h-32 items-center justify-center rounded-2xl bg-white p-8 text-center text-gray-500">
                  {s("filial.no_branches", lang)}
                </div>
                ) : (
                <div className="mt-4 grid gap-6 md:grid-cols-2">
                  {locations.map((loc) => (
          ...
          <div className="mx-auto mt-6 h-80 md:h-120">
            <ContactMap
              locations={locations
